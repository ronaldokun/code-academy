...
class RES18_SSD(nn.Module):
    ...
    def __init__(self, num_classes, bboxes, pretrain=None ):
        ...
        resnet = ResNet18()
        if pretrain:
            net = torch.load('/media/datasets/ComputerVision/Cap02/Mini-Projeto1/pesos/newresnet.pth')
...
class RES101_SSD(nn.Module):
    ...
    def __init__(self, num_classes, bboxes, pretrain=None ):
        ...
        resnet = ResNet101()
        if pretrain:
            net = torch.load('/media/datasets/ComputerVision/Cap02/Mini-Projeto1/pesos/resnet101-5d3b4d8f.pth')
